...
export default class PackageDetail extends Component<
  PackageDetailProps & RouteComponentProps,
  PackageDetailState | {}
> {
  state = {
    packageName: "",
  ...
  async componentDidMount() {
    ...
    packageData.data.Description
      ? this.setState({ packageDescription: packageData.data.Description })
      : "";
    packageData.data.Depends
      ? this.setState({ dependencies: packageData.data.Depends })
      : [];
